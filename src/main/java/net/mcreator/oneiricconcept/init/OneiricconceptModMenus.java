...
public class OneiricconceptModMenus {
	...
	public static final DeferredHolder<MenuType<?>, MenuType<VastSeaGUIMenu>> VAST_SEA_GUI = REGISTRY.register("vast_sea_gui", () -> IMenuTypeExtension.create(VastSeaGUIMenu::new));
