...
public class PhlogistontankBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public Component getDefaultName() {
		return Component.literal("phlogistontank");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new PhlogistontankGuiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
