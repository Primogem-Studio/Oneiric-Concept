...
public class ExplosiveHydroEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(OneiricconceptModItems.HYDRO_BOOMYAM.get());
	...
	protected ItemStack getDefaultPickupItem() {
		return new ItemStack(OneiricconceptModItems.HYDRO_BOOMYAM.get());
	}
