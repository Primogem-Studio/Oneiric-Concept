...
import net.mcreator.oneiricconcept.procedures.BaryonPlaceProcedure;
...
public class BaryonEntity extends Monster implements RangedAttackMob {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new RangedAttackGoal(this, 1.25, 160, 16f) {
			@Override
	...
	public void die(DamageSource source) {
		super.die(source);
		AntimatterLegionLootProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), source.getEntity());
	}
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		OnLaserEntity.shoot(this, target);
	}

	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(OneiricconceptModEntities.BARYON.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
			return BaryonPlaceProcedure.execute(world, x, y, z);
