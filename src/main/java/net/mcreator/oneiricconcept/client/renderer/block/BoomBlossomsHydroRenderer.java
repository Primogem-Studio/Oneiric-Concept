...
public class BoomBlossomsHydroRenderer implements BlockEntityRenderer<BoomBlossomsHydroBlockEntity> {
	...
	BoomBlossomsHydroRenderer(BlockEntityRendererProvider.Context context) {
		this.model = new CustomHierarchicalModel(context.bakeLayer(Modelboom_blossoms.LAYER_LOCATION));
		this.texture = ResourceLocation.parse("oneiricconcept:textures/block/boom_blossoms_hydro.png");
	}

	private void updateRenderState(BoomBlossomsHydroBlockEntity blockEntity) {
	...
	@Override
	public void render(BoomBlossomsHydroBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource renderer, int light, int overlayLight) {
	...
	public static void registerBlockEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		event.registerBlockEntityRenderer(OneiricconceptModBlockEntities.BOOM_BLOSSOMS_HYDRO.get(), BoomBlossomsHydroRenderer::new);
	}
