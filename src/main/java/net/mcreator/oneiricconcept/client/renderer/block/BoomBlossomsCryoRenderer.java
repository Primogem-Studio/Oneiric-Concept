...
public class BoomBlossomsCryoRenderer implements BlockEntityRenderer<BoomBlossomsCryoBlockEntity> {
	private final CustomHierarchicalModel model;
	private final ResourceLocation texture;

	BoomBlossomsCryoRenderer(BlockEntityRendererProvider.Context context) {
		this.model = new CustomHierarchicalModel(context.bakeLayer(Modelboom_blossoms.LAYER_LOCATION));
		this.texture = ResourceLocation.parse("oneiricconcept:textures/block/boom_blossoms_cryo.png");
	}

	private void updateRenderState(BoomBlossomsCryoBlockEntity blockEntity) {
	...
	@Override
	public void render(BoomBlossomsCryoBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource renderer, int light, int overlayLight) {
	...
	public static void registerBlockEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		event.registerBlockEntityRenderer(OneiricconceptModBlockEntities.BOOM_BLOSSOMS_CRYO.get(), BoomBlossomsCryoRenderer::new);
	}
	...
	private static final class CustomHierarchicalModel extends Modelboom_blossoms {
		...
		public void setupBlockEntityAnim(BoomBlossomsCryoBlockEntity blockEntity, float ageInTicks) {
