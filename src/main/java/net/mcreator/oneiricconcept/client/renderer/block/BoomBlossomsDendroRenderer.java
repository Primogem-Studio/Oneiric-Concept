...
public class BoomBlossomsDendroRenderer implements BlockEntityRenderer<BoomBlossomsDendroBlockEntity> {
	private final CustomHierarchicalModel model;
	private final ResourceLocation texture;

	BoomBlossomsDendroRenderer(BlockEntityRendererProvider.Context context) {
		this.model = new CustomHierarchicalModel(context.bakeLayer(Modelboom_blossoms.LAYER_LOCATION));
		this.texture = ResourceLocation.parse("oneiricconcept:textures/block/boom_blossoms_dendro.png");
	}

	private void updateRenderState(BoomBlossomsDendroBlockEntity blockEntity) {
	...
	@Override
	public void render(BoomBlossomsDendroBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource renderer, int light, int overlayLight) {
	...
	public static void registerBlockEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		event.registerBlockEntityRenderer(OneiricconceptModBlockEntities.BOOM_BLOSSOMS_DENDRO.get(), BoomBlossomsDendroRenderer::new);
	}
	...
	private static final class CustomHierarchicalModel extends Modelboom_blossoms {
		...
		public void setupBlockEntityAnim(BoomBlossomsDendroBlockEntity blockEntity, float ageInTicks) {
