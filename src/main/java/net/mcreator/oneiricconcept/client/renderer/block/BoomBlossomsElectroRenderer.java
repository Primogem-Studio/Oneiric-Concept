...
public class BoomBlossomsElectroRenderer implements BlockEntityRenderer<BoomBlossomsElectroBlockEntity> {
	private final CustomHierarchicalModel model;
	private final ResourceLocation texture;

	BoomBlossomsElectroRenderer(BlockEntityRendererProvider.Context context) {
		this.model = new CustomHierarchicalModel(context.bakeLayer(Modelboom_blossoms.LAYER_LOCATION));
		this.texture = ResourceLocation.parse("oneiricconcept:textures/block/boom_blossoms_electro.png");
	}

	private void updateRenderState(BoomBlossomsElectroBlockEntity blockEntity) {
	...
	@Override
	public void render(BoomBlossomsElectroBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource renderer, int light, int overlayLight) {
	...
	public static void registerBlockEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		event.registerBlockEntityRenderer(OneiricconceptModBlockEntities.BOOM_BLOSSOMS_ELECTRO.get(), BoomBlossomsElectroRenderer::new);
	}
	...
	private static final class CustomHierarchicalModel extends Modelboom_blossoms {
		...
		public void setupBlockEntityAnim(BoomBlossomsElectroBlockEntity blockEntity, float ageInTicks) {
