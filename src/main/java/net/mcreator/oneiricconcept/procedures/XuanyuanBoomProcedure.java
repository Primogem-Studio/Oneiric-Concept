...
public class XuanyuanBoomProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity immediatesourceentity) {
		...
		RangeDamageProcedure.execute(world, x, y, z, new DamageSource(world.holderOrThrow(ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.parse("oneiricconcept:honkai"))), immediatesourceentity, entity), 280, 67);
		...
		ExplosionIgnitesProcedure.execute(world, x, y, z, 0, 47);
	}
}