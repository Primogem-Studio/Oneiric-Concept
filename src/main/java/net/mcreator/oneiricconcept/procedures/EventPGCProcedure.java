...
public class EventPGCProcedure {
    public static void execute() {
        ...
        Event_item_sxRProcedure.registerEvent(2002, (world, entity) -> {OccurrencesTheMarshmallowProcedure.execute(world,entity);return true;});
        //事件组
        EventGroupProcedure.registerGroup(1000, (entity, world) -> {return EventGroupProcedure.zu(entity, 2000, 2001, 7, "§e我不吃牛肉...吗？");});
        EventGroupProcedure.registerGroup(1001, (entity, world) -> {return EventGroupProcedure.zu(entity, 2002, 2002, 0, "§c飞向高天");});
        //事件描述
