...
public class DarkXuanyuanSwordItem extends Item {
	public DarkXuanyuanSwordItem() {
		super(new Item.Properties().stacksTo(1).fireResistant().rarity(Rarity.EPIC)
				.attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 27, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.oneiricconcept.dark_xuanyuan_sword.description_0"));
		list.add(Component.translatable("item.oneiricconcept.dark_xuanyuan_sword.description_1"));
	}
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entity, int time) {
		if (!world.isClientSide() && entity instanceof ServerPlayer player) {
			...
			if (player.getAbilities().instabuild || stack != ItemStack.EMPTY) {
				...
				CoreDelProcedure.execute(entity);
			}
		}
	}
