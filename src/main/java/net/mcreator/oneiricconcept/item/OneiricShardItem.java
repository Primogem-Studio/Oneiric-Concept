...
import net.mcreator.oneiricconcept.procedures.OneiricShardBuffProcedure;
...
public class OneiricShardItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.oneiricconcept.oneiric_shard.description_0"));
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		OneiricShardBuffProcedure.execute(entity);
		return retval;
	}
}