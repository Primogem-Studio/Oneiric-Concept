...
import net.mcreator.oneiricconcept.procedures.MoraDamageProcedure;
...
public class BossStoneCoinGunItem extends Item {
	...
	public void onUseTick(Level world, LivingEntity entity, ItemStack itemstack, int count) {
		if (!world.isClientSide() && entity instanceof ServerPlayer player) {
			...
			if (player.getAbilities().instabuild || stack != ItemStack.EMPTY) {
				MoraCoinEntity projectile = MoraCoinEntity.shoot(world, entity, world.getRandom());
	...
	private ItemStack findAmmo(Player player) {
		return new ItemStack(MoraCoinEntity.PROJECTILE_ITEM.getItem());
	}
}
