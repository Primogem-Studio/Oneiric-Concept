...
import net.mcreator.oneiricconcept.procedures.EnergydrinktxtProcedure;
...
public class PunitiveEnergyItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		String hoverText = EnergydrinktxtProcedure.execute();
		if (hoverText != null) {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		SpeedJumpProcedure.execute(world, entity, itemstack);
