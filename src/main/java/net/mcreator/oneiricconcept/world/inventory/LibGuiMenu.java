...
public class LibGuiMenu extends AbstractContainerMenu implements OneiricconceptModMenus.MenuAccessor {
	...
	public LibGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(OneiricconceptModMenus.LIB_GUI.get(), id);
	...
	public static void onContainerOpen(PlayerContainerEvent.Open event) {
		...
		if (event.getContainer() instanceof LibGuiMenu menu) {
