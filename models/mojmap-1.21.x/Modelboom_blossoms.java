...
public class Modelboom_blossoms<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "boom_blossoms"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition melon = partdefinition.addOrReplaceChild("melon", CubeListBuilder.create(),
				PartPose.offset(0.0F, 18.0F, 0.0F));

		PartDefinition top = melon.addOrReplaceChild("top", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.7854F, 0.0F));

		PartDefinition bone = top.addOrReplaceChild("bone", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.7854F, 0.0F));

		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.3876F, -1.5F, -0.3876F, 2.0F, 1.0F, 2.0F,
		...
		PartDefinition bone2 = top.addOrReplaceChild("bone2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, 0.0F, -0.7854F, 0.0F));

		PartDefinition cube_r9 = bone2.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(5, 0).addBox(0.3784F, -2.409F, 0.3784F, 3.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r13 = bone2.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(5, 0).addBox(0.3784F, -2.8F, 0.3784F, 3.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone5 = bone2.addOrReplaceChild("bone5", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0F, -1.1781F, 0.0F));

		PartDefinition cube_r17 = bone5.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(5, 0).addBox(0.3784F, -2.409F, 0.3784F, 3.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -3.1416F, -0.7854F, 2.4435F));
		...
		PartDefinition bone3 = top.addOrReplaceChild("bone3", CubeListBuilder.create(),
				PartPose.offset(0.0F, 5.0F, 0.0F));

		PartDefinition cube_r25 = bone3.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(0, 5).addBox(-0.3876F, -1.5F, -0.3876F, 5.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone4 = bone3.addOrReplaceChild("bone4", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -4.5253F, 0.0F, 0.0F, -0.7854F, 0.0F));

		PartDefinition cube_r29 = bone4.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(13, 0).addBox(-0.3876F, -1.5F, -0.3876F, 4.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -1.4747F, 0.0F, -3.1416F, -0.7854F, 2.0944F));

		PartDefinition cube_r30 = bone4.addOrReplaceChild("cube_r30",
				CubeListBuilder.create().texOffs(13, 0).addBox(-0.3876F, -1.5F, -0.3876F, 4.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition down = melon.addOrReplaceChild("down", CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F,
				-1.0F, -4.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 4.0F, 0.0F));

		PartDefinition bone7 = down.addOrReplaceChild("bone7", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 2.0F, 0.0F, 0.0F, 1.1781F, 0.0F));

		PartDefinition cube_r33 = bone7.addOrReplaceChild("cube_r33",
				CubeListBuilder.create().texOffs(0, 11).addBox(-0.3876F, 0.5F, -0.3876F, 4.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r36 = bone7.addOrReplaceChild("cube_r36",
				CubeListBuilder.create().texOffs(0, 11).addBox(-0.3876F, 0.5F, -0.3876F, 4.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r37 = bone8.addOrReplaceChild("cube_r37",
				CubeListBuilder.create().texOffs(0, 11).addBox(-0.3876F, 0.5F, -0.3876F, 4.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -2.0F, 0.0F, 3.1416F, -0.7854F, -2.4435F));

		PartDefinition cube_r38 = bone8.addOrReplaceChild("cube_r38",
				CubeListBuilder.create().texOffs(0, 11).addBox(-0.3876F, 0.5F, -0.3876F, 4.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 3.0F, 0.8706F, -0.5724F, -0.5713F));
		...
		PartDefinition top2 = leaf.addOrReplaceChild("top2", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r41 = top2.addOrReplaceChild("cube_r41",
				CubeListBuilder.create().texOffs(0, 25).addBox(-8.0F, -1.0F, 2.0F, 6.0F, 1.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5126F, -1.4398F, 1.6434F));

		PartDefinition cube_r42 = top2.addOrReplaceChild("cube_r42",
				CubeListBuilder.create().texOffs(0, 25).addBox(-8.0F, -1.0F, 2.0F, 6.0F, 1.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -3.0114F, 0.0095F, 3.011F));

		PartDefinition cube_r43 = top2.addOrReplaceChild("cube_r43",
				CubeListBuilder.create().texOffs(0, 25).addBox(-8.0F, -1.0F, 2.0F, 6.0F, 1.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.629F, 1.4398F, 1.4982F));

		PartDefinition cube_r44 = top2.addOrReplaceChild("cube_r44",
				CubeListBuilder.create().texOffs(0, 25).addBox(-8.0F, -1.0F, 2.0F, 6.0F, 1.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1302F, -0.0095F, 0.1306F));

		PartDefinition dowm = leaf.addOrReplaceChild("dowm", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r45 = dowm.addOrReplaceChild("cube_r45",
				CubeListBuilder.create().texOffs(0, 11).mirror()
						.addBox(-4.0F, -1.0F, 0.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(8.0F, 0.0F, 0.0F, 0.0F, -0.7854F, 0.0F));

		PartDefinition cube_r46 = dowm.addOrReplaceChild("cube_r46",
				CubeListBuilder.create().texOffs(0, 11).addBox(0.0F, -1.0F, 0.0F, 4.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r47 = dowm.addOrReplaceChild("cube_r47",
				CubeListBuilder.create().texOffs(0, 11).mirror()
						.addBox(-4.0F, -1.0F, 0.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, -8.0F, 0.0F, 0.7854F, 0.0F));

		PartDefinition cube_r48 = dowm
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay,
		...
		melon.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
